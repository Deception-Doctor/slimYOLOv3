"""YOLOv3 PyTorch Hub models2 https://pytorch.org/hub/ultralytics_yolov3/
...
def _create(name, pretrained=True, channels=3, classes=80, autoshape=True, verbose=True, device=None):
    ...
    from models2.yolo import Model, attempt_load
    ...
    try:
        if pretrained and channels == 3 and classes == 80:
            ...
            cfg = list((Path(__file__).parent / 'models2').rglob(f'{name}.yaml'))[0]  # model.yaml path
