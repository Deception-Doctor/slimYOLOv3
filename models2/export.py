...
Usage:
    $ python path/to/models2/export.py --weights yolov3.pt --img 640 --batch 1
"""
...
if __name__ == '__main__':
    ...
    for k, m in model.named_modules():
        ...
        if isinstance(m, models2.common.Conv):  # assign export-friendly activations
            if isinstance(m.act, nn.Hardswish):
                m.act = Hardswish()
            elif isinstance(m.act, nn.SiLU):
                m.act = SiLU()
        elif isinstance(m, models2.yolo.Detect):
