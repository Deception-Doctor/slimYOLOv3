...
def test(
    ...
    """prune yolov3_1 and generate cfg, weights
    """
    if save != None:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='VisDrone2019/yolov3_1-spp3.cfg', help='cfg file path')
    parser.add_argument('--weights', type=str, default='yolov3_1-spp3_final.weights', help='path to weights file')
